...
const BlogPage = () => {
    ...
    const fetchBlog = () => {
        ...
        .then(async( {data: {blog}}) => {
            ...
            axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/blog/search-blogs", {tag: blog.tags[0], limit: 6, eliminate_blog: blog_id})
            .then(({data}) => {
                        ...
                        <div className="my-12 font-gelasio blog-page-content">
                            {
                                content[0].blocks.map((block, idx) => {
                                    return <div key={idx} className="my-4 md:my-8">
                                ...
                                <>
...

                                    {
                                        similarBlogs.map((blog, idx) => {
                                            ...
                                            return <AnimationWrapper key={idx} transition={{ duration: 1, delay: idx*0.08}}>
