...
const ManageBlogs = () => {
    ...
    const getBlogs = ({page, draft, deletedDocCount=0}) => {
        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/blog/user-written-blogs", {
        ...
        <>
            ...
            <InPageNavigation routes={["Published Blogs", "Drafts"]} defaultActiveIndex={activeTab != 'draft' ? 0 : 1}>
                    ...
                    <>
                        {
                            blogs.results.map((blog, idx) => {
                                return <AnimationWrapper key={idx} transition={{ delay: idx * 0.04}}>

                                    <ManagePublishedBlogCard blog={{...blog, index: idx, setStateFunc: setBlogs}} />
                ...
                {// Draft Blogs
                    ...
                    <>
                        {
                            drafts.results.map((draft, idx) => {
                                return <AnimationWrapper key={idx} transition={{ delay: idx * 0.04}}>

                                    <ManageDraftBlogPost blog={{...draft, index: idx, setStateFunc: setDrafts}}  />
