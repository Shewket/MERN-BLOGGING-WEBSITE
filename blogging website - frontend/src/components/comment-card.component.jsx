    ...
    const removeCommentsCards = (startingPoint, isDelete = false) => {   
        ...
        if(isDelete){
            ...
            if(parentIndex != undefined){
                commentsArr[parentIndex] = commentsArr[parentIndex].children.filter(child => child != _id)
        ...
        setBlog({...blog, comments: {results: commentsArr}, activity: {...activity, total_parent_comments: total_parent_comments - (commentData.childrenLevel && isDelete ? 1 : 0)}})
